...
- Action nav state must update
- Forms must have JS validation
- Button must show hover + active states
...
1. Layouts works on mobile, tablet, desktop
2. No horizonal scrol on mobile
...
--------------------------------------------------
{
   "message" : "Short professional cofirmation sentence",
...
export const deleteWebsite = async (req, res) => {
  try {
    ...
    return res.status(500).json({ message: `Failed to delete website: ${error}` });
  }
};
