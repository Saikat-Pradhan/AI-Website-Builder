            ...
            <div className='flex-1 flex flex-col'>
                <div className='h-14 px-4 flex justify-between items-center border-b border-white/20 bg-black/80'>
                    ...
                    <div className='flex gap-2'>
                        {!website.deployed && !deployed && (<button onClick={handleDeploy} className='sm:hidden flex items-center gap-2 px-4 py-1.5 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-sm font-semibold hover:scale-105 transition cursor-pointer'><Rocket size={14} /> Deploy</button>)}
