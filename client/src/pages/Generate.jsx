      ...
      <div className='max-w-6xl mx-auto px-6 py-16'>
        ...
        <div className='flex justify-center'>
          <motion.button
            ...
            disabled={generating}
            className='px-14 py-4 rounded-2xl font-semibold text-lg bg-white text-black disabled:bg-gray-600 disabled:text-white cursor-pointer'
          >
